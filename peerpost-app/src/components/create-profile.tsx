...
/** Inline form to create a profile inside a team. */
export function CreateProfile({ teamId }: { teamId: string }) {
	...
	async function submit(e: React.FormEvent) {
		...
		setError(null);
		try {
			const res = await fetch(`/api/teams/${teamId}/profiles`, {
				method: "POST",
		...
		>
			<div className="flex-1">
				...
				<input
					...
					required
					maxLength={200}
					placeholder="e.g. KAILASA Global"
